...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ejc-autocomplete" '("ac-source-ejc-" "ejc-ac-hook")))
...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "ejc-completion-common" '("ac-ejc-documentation" "ejc-")))
