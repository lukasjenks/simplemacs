...
(custom-set-variables
 ...
 '(lsp-server-install-dir "/home/lukas/.emacs.d/elpa")
 '(magit-diff-use-overlays nil)
 '(nrepl-message-colors
   '("#fb4933" "#d65d0e" "#d79921" "#747400" "#b9b340" "#14676b" "#689d6a" "#d3869b" "#b16286"))
 '(objed-cursor-color "#ff5370")
 '(package-selected-packages
   '(gnu-elpa prettier keytar lsp-grammarly highlight-indent-guides indent-guide auto-indent-mode auto-auto-indent adjust-parens treemacs-icons-dired treemacs-all-the-icons auto-package-update dash which-key lsp-pyright helm-lsp lsp-docker lua-mode lsp-ui lsp-pyre lsp-mssql lsp-javacomp lsp-intellij lsp-java lsp-mode bind-key 2bit free-keys clojure-mode aggressive-indent curl-to-elisp restclient request rjsx-mode ejc-sql go-complete go-imports go-projectile chess evil foggy-night-theme exec-path-from-shell json-mode js2-mode web-mode powerline all-the-icons neotree doom-themes darcula-theme flycheck cherry-blossom-theme solarized-theme night-owl-theme helm tide go-mode gandalf-theme gdscript-mode xkcd restart-emacs company-web company-shell company-restclient company-plsense company-go company-c-headers company auto-complete org-bullets org slime centaur-tabs treemacs hlinum monokai-theme rainbow-delimiters))
